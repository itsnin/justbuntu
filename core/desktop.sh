...
run_script "$HOME/.local/share/justbuntu/provision/configure/gnome/keybindings.sh"
...
for installer in "$HOME/.local/share/justbuntu/provision/configure/gnome/"*.sh; do
